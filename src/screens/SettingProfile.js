        ...
        <>
            ...
            <div className="setting-container">
                ...
                <div className="setting-content-box">
                    ...
                    <div className="settingCard">
                        <div>
                            <h2 className="setting-headding">บัญชีธนาคาร</h2>
                        </div>
                        <div className="in-setting-page">
                            <form >

                                <div>
                                    <label class="onInput">ชื่อบัญชีธนาคาร</label>
                                    <TextareaAutosize
                                        className="txtarea"
                                        id="bankAccName"
                                        maxlength="50"
                                        disabled={!isShow}
                                        style={isShow ? { borderColor: 'black' } : { borderColor: 'transparent' }}
                                ...
                                <div className="text-align-center" id="sendDataBankBtn" style={isShow ? { display: "block" } : { display: "none", borderColor: 'black' }}>
                                    ...
                                    <button className="cancle-btn" type="button" onClick={handleHidden}>
                                        ยกเลิก
                                    </button>
                                </div>
                            </form>
